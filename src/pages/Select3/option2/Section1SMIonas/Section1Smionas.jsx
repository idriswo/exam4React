...
const Section1Smionas = memo(() => {
  return (
    <div className="w-full flex relative justify-center bg-[#ffffff] z-10 p-[24px] font-sans">
      <div className="w-full max-w-[1400px] flex flex-col lg:flex-row border-[1px] border-[#d4d4d4]">
...
export default Section1Smionas